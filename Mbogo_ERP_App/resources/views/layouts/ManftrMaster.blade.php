        ...
        <nav id="sidebar" class="navbar-default navbar-static-side" role="navigation"
            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    @endcan
                    @can('View-Manufacturing-Inventory-Menu')
                        <li>
                            <a href="#"><i class="fa fa-cogs"></i> <span class="nav-label">Manufacturing Module
                                </span> <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                @can('View-Raw-Material-Inventory-Menu')
                                    <li>
                                        <a href="#"><i class="fa fa-linode"></i> <span class="nav-label">Material
                                                Menu</span> <span class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level collapse">
                                            @can('View-Manufacturing-Raw-Material-Request')
                                                <li><a href="{{ route('manfctr.requests.index') }}">Request Raw Material</a></li>
                                            @endcan
                                            @can('View-Manufacturing-Receipts')
                                                <li><a href="{{ route('manfctr.receipts.index') }}">Receive Raw Material</a></li>
                                            @endcan
                                            @can('View-Manufacturing-Consumption')
                                                <li><a href="{{ route('manfctr.consumption.index') }}">Raw Material Used</a>
                                                </li>
                                            @endcan
                                            @can('View-Manufacturing-Stock-Movement')
                                                <li><a href="{{ route('manfctr.stock.movement.index') }}">Material Stock
                                                        Movement</a>
                                                </li>
                                            @endcan
                                            @can('View-Manufacturing-Stock')
                                                <li><a href="{{ route('manfctr.stock.index') }}">Raw Material Stock</a>
                                                </li>
                                            @endcan
                                        </ul>
                                    </li>
                                @endcan
                                @can('View-Product-Inventory-Menu')
                                    <li>
                                        <a href="#"><i class="fa fa-product-hunt"></i> <span class="nav-label">Product
                                                Menu</span> <span class="fa arrow"></span></a>
                                        <ul class="nav nav-second-level collapse">
                                            @can('View-Packed-Product')
                                                <li><a href="{{ route('manfctr.packed.index') }}">Packed Product</a></li>
                                            @endcan
                                            @can('View-Product-Order')
                                                <li><a href="{{ route('manfctr.orders.index') }}">Order Product</a></li>
                                            @endcan
                                            @can('View-Issued-Product')
                                                <li><a href="{{ route('manfctr.iss.index') }}">Issued Product</a></li>
                                            @endcan
                                            @can('View-Product-Stock')
                                                <li><a href="{{ route('manfctr.stocks.index') }}">Product Stock</a></li>
                                            @endcan
                                            @can('View-Product-Stock-Movement')
                                                <li><a href="{{ route('manfctr.prdstockmovement.index') }}">Stock Movement</a>
                                                </li>
                                            @endcan
                                        </ul>
                                    </li>
                    ...
                    @endcan
                   @can('View-Drilling-Blasting-Menu')
                    <li>
                        <a href="#">
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li>
                                <a href="{{ route('production.drilling-blasting.index') }}">
                    ...
                    @endcan
                    @can('View-Water-Supply-Menu')
                        <li>
                            <a href="#"><i class="fa fa-tint"></i> <span class="nav-label">Water Supply Module
                                </span> <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                    ...
                    @endcan
                    @can('View-Construction-Menu')
                        <li>
                            <a href="#"><i class="fa fa-codepen"></i> <span class="nav-label">Construction Module
                                </span> <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                    ...
                    @endcan
                    @can('View-Innovation-Menu')
                        <li>
                            <a href="#"><i class="fa fa-filter"></i> <span class="nav-label">Research &
                                    Innovation</span>
                                <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                @can('View-Raw-Material-Menu')
                                    <li>
                                        <a href="#"><i class="fa fa-linode"></i> <span class="nav-label">Raw Material
                                                Menu</span> <span class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level collapse">
                                            @can('View-Raw-Material')
                                                <li><a href="{{ route('manfctr.rawmaterials.index') }}">Raw Material Details</a>
                                                </li>
                                            @endcan
                                            @can('View-Raw-Material-Price')
                                                <li><a href="{{ route('manfctr.rawprices.index') }}">Raw Material Price</a></li>
                                            @endcan
                                        </ul>
                                    </li>
                                @endcan
                                @can('View-Product-Menu')
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level collapse">
                                            @can('View-Product')
                                                <li><a href="{{ route('manfctr.products.index') }}">Product Details</a></li>
                                            @endcan
                                            @can('View-Product-Price')
                                                <li><a href="{{ route('manfctr.prdprices.index') }}">Product Price</a></li>
                                            @endcan
                                        </ul>
                                    </li>
                                @endcan
                               <!--   @can('View-ICT-Issues-Menu')
                                    <li>
                                        <a href="#"><i class="fa fa-ICT Issues-laptop"></i> <span class="nav-label">ICTIssues
                                                Menu</span> <span class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level collapse">
                                            @can('View-ICT-Issues')
                                                <li><a href="{{ route('manfctr.products.index') }}">ICTIssues Details</a></li>
                                            @endcan
                                            @can('View-ICT-Issues')
                                                <li><a href="{{ route('manfctr.prdprices.index') }}">Product Price</a></li>
                                            @endcan
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm welcome-message"
                                style="color:#000;font-size:25px;font-weight:bold">Production & Manufacturing
                                Module</span>
                        </li>
                        <li>
                            <select id="move-module" class="form-control" aria-label="Move to another module"
                                ...
                                @can('Business-Development-Sales-Marketing-Modules')
                                    @unless (request()->routeIs('sales management'))
                                        <option value="{{ route('sales.management.dashboard') }}">Business Development, Sales & Marketing
                                        </option>
                                    @endunless
                                @endcan
                            ...
                            @can('Store-Management-Modules')

                                @unless(request()->routeIs('store.management.dashboard'))

                                    <option value="{{ route('store.management.dashboard') }}">
