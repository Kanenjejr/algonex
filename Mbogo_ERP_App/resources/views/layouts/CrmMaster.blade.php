        ...
        <nav id="sidebar" class="navbar-default navbar-static-side" role="navigation"
            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    @endcan
                    @can('View-CustomerSupplier-Menu')
                        <li>
                            <a href="#"><i class="fa fa-users"></i> <span class="nav-label">Customers /
                                    Suppliers</span> <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                @can('View-CustomerSupplier')
                                    <li><a href="{{ route('crm.cstm.index') }}">Customers & Suppliers</a></li>
                                @endcan
                                @can('View-Customer-Orders')
                                    <li><a href="{{ route('crm.orders.index') }}">Orders Details</a></li>
                                @endcan
                                @can('View-Customer-Order-Items')
                                    <li><a href="{{ route('crm.items.index') }}">Order Items Details</a></li>
                                @endcan
                                @can('View-Customer-Ledger')
                                    <li><a href="{{ route('crm.tx.index') }}">Ledger / Transactions</a></li>
                                @endcan
                                @can('View-CustomerSupplier-Reports')
                                    <li><a href="{{ route('crm.reports.index') }}">Customer / Supplier Reports</a></li>
                                @endcan
                            </ul>
                        </li>
                    @endcan
                    @can('View-Hired-Equipment-Menu')
                        <li>
                            <a href=""><i class="fa fa-anchor"></i> <span class="nav-label"> Hired
                                    Equipment</span> <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                @can('View-Hired-Equipment-Details')
                                    <li>
                                        <a href="{{ route('hired.index') }}"><i class="fa fa-bar-chart"></i><span
                                                class="nav-label">Equipment Details</span></a>
                                    </li>
                                @endcan
                                @can('View-Hired-Equipment-Workings')
                                    <li>
                                        <a href="{{ route('hired.workings.index') }}"><i class="fa fa-tasks"></i><span
                                                class="nav-label">Working Details</span></a>
                                    </li>
                                @endcan
                                @can('View-Hired-Equipment-Reports')
                                    <li>
                                        <a href="{{ route('hired.workings.reports') }}"><i class="fa fa-files-o"></i><span
                                                class="nav-label"> View Reports</span></a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm welcome-message"
                                style="color:#000;font-size:25px;font-weight:bold">Customers & Supplies Module</span>
                        </li>
                        <li>
