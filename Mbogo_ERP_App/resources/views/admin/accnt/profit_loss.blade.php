...
@section('content')
    @php
        $pageTitle = 'Profit And Loss Report Information';
        $breadcrumbTitle = 'Profit And Loss Report';
        $formAction = route('profitloss', ['year' => $year ?? request()->route('year')]);
        $reportTitle = 'STATEMENT OF COMPREHENSIVE INCOME / PROFIT AND LOSS';
                            ...
                            <div class="fs-page">
                                ...
                                <table class="fs-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $fmt($cur('revenue')) }}</td>
                                        <td class="text-right">{{ $fmt($prev('revenue')) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Less: Cost of Revenue</td>
                                        <td><a class="note-link" href="#note3">Note 3</a></td>
                                        <td class="text-right">{{ $fmt(-abs($cur('cost_of_revenue'))) }}</td>
                                        <td class="text-right">{{ $fmt(-abs($prev('cost_of_revenue'))) }}</td>
                                    </tr>
                                    <tr class="sub-total">
                                        <td>Gross Profit</td>
                                        <td></td>
                                        <td class="text-right">{{ $fmt($cur('gross_profit')) }}</td>
                                        <td class="text-right">{{ $fmt($prev('gross_profit')) }}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td class="text-right">{{ $fmt($cur('other_income')) }}</td>
                                        <td class="text-right">{{ $fmt($prev('other_income')) }}</td>
                                    </tr>
                                    <tr class="sub-total">
                                        <td>Total Income</td>
                                        <td></td>
                                        <td class="text-right">{{ $fmt($cur('total_income')) }}</td>
                                        <td class="text-right">{{ $fmt($prev('total_income')) }}</td>
                                    </tr>
                                    <tr class="section-row">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $fmt(-abs($cur('administrative_expenses'))) }}</td>
                                        <td class="text-right">{{ $fmt(-abs($prev('administrative_expenses'))) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Selling & Distribution Cost</td>
                                        <td><a class="note-link" href="#note5">Note 5</a></td>
                                        <td class="text-right">{{ $fmt(-abs($cur('selling_distribution'))) }}</td>
                                        <td class="text-right">{{ $fmt(-abs($prev('selling_distribution'))) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Depreciation & amortization</td>
                                        <td><a class="note-link" href="#note7">Note 7</a></td>
                                        <td class="text-right">{{ $fmt(-abs($cur('depreciation'))) }}</td>
                                        <td class="text-right">{{ $fmt(-abs($prev('depreciation'))) }}</td>
                                    </tr>
                                    <tr class="sub-total">
                                        <td>Profit Before Interest and Tax</td>
                                        <td></td>
                                        <td class="text-right">{{ $fmt($cur('profit_before_interest_tax')) }}</td>
                                        <td class="text-right">{{ $fmt($prev('profit_before_interest_tax')) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="grand-total">
                                        ...
                                        <td></td>
                                        <td class="text-right">{{ $fmt($cur('profit_after_tax')) }}</td>
                                        <td class="text-right">{{ $fmt($prev('profit_after_tax')) }}</td>
                                    </tr>
                                </table>
