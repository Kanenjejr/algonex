...
@section('content')
    @php
        $pageTitle = 'Change In Equity Report Information';
        $breadcrumbTitle = 'Change In Equity Report';
        $formAction = route('changeinequity', ['year' => $year ?? request()->route('year')]);
                            ...
                            <div class="fs-page">
                                ...
                                <table class="fs-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">Retained Earnings /<br>Accumulated Loss<br>TSHS</th>
                                        <th class="text-right">Total Equity<br>TSHS</th>
                                    </tr>
                                    <tr>
                                        <td>Balance at {{ \Carbon\Carbon::parse($prev_end_date)->format('d.m.Y') }}</td>
                                        <td class="text-right">{{ $fmt($cur('opening_capital')) }}</td>
                                        <td class="text-right">{{ $fmt($cur('opening_retained_earnings')) }}</td>
                                        <td class="text-right">{{ $fmt($cur('opening_total_equity')) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="grand-total">
                                        <td>Balance at {{ \Carbon\Carbon::parse($end_date)->format('d.m.Y') }}</td>
                                        <td class="text-right">{{ $fmt($cur('closing_capital')) }}</td>
                                        <td class="text-right">{{ $fmt($cur('closing_retained_earnings')) }}</td>
                                        <td class="text-right">{{ $fmt($cur('closing_total_equity')) }}</td>
                                    </tr>
                                </table>
                                <br>
                                <table class="fs-table">
                                    <tr class="section-row">
                                        <td colspan="5">Share holder and share holdings</td>
                                    </tr>
                                    <tr>
                                        <th>S/N</th>
                                        <th>Name</th>
                                    ...
                                    @forelse(($shareholders ?? []) as $idx => $s)
                                        <tr>
                                            <td>{{ $idx + 1 }}</td>
                                            <td>{{ $rowGet($s, 'name') }}</td>
                                            <td class="text-right">{{ $fmt($rowGet($s, 'share')) }}</td>
                                            <td class="text-right">{{ $fmt($rowGet($s, 'value_per_share')) }}</td>
                                            <td class="text-right">{{ $fmt($rowGet($s, 'total')) }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td>1</td>
                                    ...
                                    @endforelse
                                    <tr class="grand-total">
                                        <td colspan="2">Total share Capital</td>
                                        <td class="text-right">{{ $fmt($cur('total_shares')) }}</td>
                                        <td></td>
                                        <td class="text-right">{{ $fmt($cur('share_capital_total')) }}</td>
                                    </tr>
                                </table>
